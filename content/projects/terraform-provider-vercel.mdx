...
date: "2021-03-16"
repository: joshjgomes/solidify
...
I needed to manage my Vercel apps and especially sync environment variables from different cloud providers.
...
resource "vercel_app" "my_app" {
  name = "app-via-terraform"
  git_repository {
    type = "github"
...
It was a fun app and I learned a lot about Terraform and Vercel's API.
